...
ws.Proxy.Credentials = CredentialCache.DefaultCredentials
        ...
        Dim wsWynik As wsCursorProf.RaportStanWczytajWynik

        'odczyt z serwera
        Try
            Cursor = Cursors.WaitCursor
            Application.DoEvents()
            wsWynik = ws.RaportStanWczytaj(frmGlowna.sesja)
        ...
        If wsWynik.status = -1 Then
            ...
            Return False
        End If
        Me.Text = "Raport stanów magazynowych na dzień " & Today
